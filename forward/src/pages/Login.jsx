...
function Login() {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
          ...
          {currentState ==='Login' ? "" : <input type="text" className='w-full px-3 py-2 border border-gray-500' placeholder='Name' required/>}
          <input type="email" className='w-full px-3 py-2 border border-gray-500' placeholder='Email' required/>
          <input type="password" className='w-full px-3 py-2 border border-gray-500' placeholder='Password' required/>
